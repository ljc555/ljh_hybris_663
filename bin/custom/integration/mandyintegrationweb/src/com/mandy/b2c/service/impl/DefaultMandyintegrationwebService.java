...
public class DefaultMandyintegrationwebService implements MandyintegrationwebService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMandyintegrationwebService.class);
	...
	{
		return DefaultMandyintegrationwebService.class.getResourceAsStream("/mandyintegrationweb/sap-hybris-platform.png");
	}
