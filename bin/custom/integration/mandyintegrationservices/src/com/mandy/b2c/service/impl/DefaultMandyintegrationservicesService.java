...
public class DefaultMandyintegrationservicesService implements MandyintegrationservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMandyintegrationservicesService.class);
	...
	{
		return DefaultMandyintegrationservicesService.class.getResourceAsStream("/mandyintegrationservices/sap-hybris-platform.png");
	}
