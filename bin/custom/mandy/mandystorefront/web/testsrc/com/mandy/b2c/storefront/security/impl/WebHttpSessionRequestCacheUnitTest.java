...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mandystorefront/electronics/en",
						"https://electronics.local:9002/mandystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mandystorefront/electronics/en",
						"https://electronics.local:9002/mandystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mandystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mandystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mandystorefront/electronics/en",
						"https://electronics.local:9002/mandystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mandystorefront",
						"https://electronics.local:9002/mandystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mandystorefront",
						"https://electronics.local:9002/mandystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mandystorefront/electronics/en",
						"https://electronics.local:9002/mandystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
