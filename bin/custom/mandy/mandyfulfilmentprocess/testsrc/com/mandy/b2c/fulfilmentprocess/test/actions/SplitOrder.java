 ...
 */
package com.mandy.b2c.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MandyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MandyFulfilmentProcessConstants.PARENT_PROCESS);
