 ...
 */
package com.mandy.b2c.cockpits.setup;
...
import com.mandy.b2c.cockpits.constants.MandyCockpitsConstants;
 ...
 */
@SystemSetup(extension = MandyCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MandyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MandyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MandyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mandycockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
