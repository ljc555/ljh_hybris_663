 ...
 */
package com.mandy.b2c.core.constants;

/**
 * Global class for all MandyCore constants. You can add global constants for your extension into this class.
 */
public final class MandyCoreConstants extends GeneratedMandyCoreConstants
{
	public static final String EXTENSIONNAME = "mandycore";


	private MandyCoreConstants()
	{
		//empty
	}
