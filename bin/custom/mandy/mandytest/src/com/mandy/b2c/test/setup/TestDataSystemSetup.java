 ...
 */
package com.mandy.b2c.test.setup;
...
import com.mandy.b2c.test.constants.MandyTestConstants;
import com.mandy.b2c.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MandyTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mandytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mandytest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mandytest/import/cstickets.impex");
			...
			importImpexFile(context, "/mandytest/import/csquotes.impex");
		}
	}
}
